...
Cpp program to insert an element at the bottom of the stack (unlike its regular functionality of adding elements at the top)
...
int main()
{
    ...
    string.print();
    std::cout << std::endl
              << "Stack created...inserting '" << dataToInsert << "' at the bottom of the stack...";
    string.insertAtBottom(dataToInsert);
    string.print();
    return 0;
}
